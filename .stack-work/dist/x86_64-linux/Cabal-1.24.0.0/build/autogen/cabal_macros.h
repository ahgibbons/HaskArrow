...
/* package HaskArrow-0.1.0.0 */
#define VERSION_HaskArrow "0.1.0.0"
#define MIN_VERSION_HaskArrow(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "HaskArrow-0.1.0.0-LKRKgVvanpLFnUZCQE5Xga"

#define CURRENT_PACKAGE_KEY "HaskArrow-0.1.0.0-LKRKgVvanpLFnUZCQE5Xga"
